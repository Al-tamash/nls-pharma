...
export const metadata: Metadata = {
  ...
  description: "Leading manufacturer of Intermediates for APIs and trader of Chemicals & Solvents since 2015. Based in Hyderabad, India, serving the pharmaceutical industry with premium quality products.",
  keywords: ["Noble Life Sciences", "pharmaceutical intermediates", "API intermediates", "chemical solvents", "pharmaceutical chemicals", "Hyderabad", "India"],
