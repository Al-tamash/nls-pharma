            ...
            <div className="text-center space-y-4">
              ...
              <div className="flex flex-wrap justify-center gap-3 pt-2">
                <Button
                  ...
                  className={
                    selectedCategory === 'all' ? 'bg-primary text-primary-foreground hover:bg-primary/90' : 'hover:bg-primary/10 hover:text-primary hover:border-primary'
                  }
                ...
                {categories.map((category) => {
                  ...
                  return (
                    <Button
                      ...
                      className={isActive ? 'bg-primary text-primary-foreground hover:bg-primary/90' : 'hover:bg-primary/10 hover:text-primary hover:border-primary'}
                      onClick={() => setSelectedCategory(category.slug)}
                    >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              We offer custom synthesis and can source specific chemicals based on your
              requirements.
            </p>
